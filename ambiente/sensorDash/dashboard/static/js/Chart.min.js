    ...
    e.defaults = {
        global: {
            ...
            tooltipTemplate:  function(v) {
                    if (v.datasetLabel == 'Temperatura'){
                        return v.value.concat(' °C')
                    } else if (v.datasetLabel == 'Umidade'){ 
                        return v.value.concat(' %')
                    } else if (v.datasetLabel == 'Luminosidade'){ 
                        return v.value.concat(' lux')
                    }
